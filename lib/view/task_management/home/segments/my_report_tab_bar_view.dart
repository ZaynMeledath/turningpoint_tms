                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            '${performanceReportModel.stats?.overdueTasks ?? 0}',
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w600,
                            ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            '${performanceReportModel.stats?.openTasks ?? 0}',
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w600,
                            ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            '${performanceReportModel.stats?.inProgressTasks ?? 0}',
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w600,
                            ),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            '${performanceReportModel.stats?.completedTasks ?? 0}',
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w600,
                            ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            '${performanceReportModel.stats?.onTimeTasks ?? 0}',
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w600,
                            ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            '${performanceReportModel.stats?.delayedTasks ?? 0}',
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w600,
                            ),
